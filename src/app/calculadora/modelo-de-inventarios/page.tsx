...
const valores = [
  ...
  {
    link: "/calculadora/modelo-de-inventarios/lote-produccion",
    img: testImage,
    alt: "text",
    sub: "",
    tit: "Modelo de lote de Produccion",
    cont: "",
  },
  {
    link: "/calculadora/modelo-de-inventarios/descuentos-cantidad",
    img: testImage,
    alt: "text",
    sub: "",
    tit: "Modelo de Descuentos por Cantidad",
    cont: "",
  },
  {
